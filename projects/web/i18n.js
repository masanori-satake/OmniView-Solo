const translations = {
  ja: {
    ...
    langEn: "English",
    langJa: "日本語",
    tagline: "〜ハイブリッド会議のホワイトボードを劇的に見やすく〜",
    cta: "Chrome ウェブストアで追加 (準備中)",
    projectOverview: "プロジェクト概要",
    overviewText: "OmniView-Soloは、ハイブリッド会議において、物理的なホワイトボードの映像をリモート参加者にも見やすく共有するためのChrome拡張機能です。歪みの補正、写り込みの除去、コントラスト強調などの処理をすべてローカルブラウザ上で行います。",
    features: "特徴",
    ...
    install: "インストール方法",
    installStep1: "Chrome ウェブストアにアクセスします（公開後）。",
  ...
  en: {
    ...
    langEn: "English",
    langJa: "Japanese",
    tagline: "Enhance whiteboard visibility for hybrid meetings.",
    cta: "Add to Chrome (Coming Soon)",
    projectOverview: "Project Overview",
    overviewText: "OmniView-Solo is a Chrome extension designed to share physical whiteboard images clearly with remote participants in hybrid meetings. It performs perspective correction, occlusion removal, and contrast enhancement entirely within your local browser.",
    features: "Features",
    ...
    installStep1: "Visit the Chrome Web Store (after release).",
