const translations = {
  ja: {
    ...
    overviewText: "OmniView-Soloは、ハイブリッド会議やリモート授業において、物理的なホワイトボードの映像をリモート参加者や生徒にも見やすく共有し、全体のUXを向上させるためのChrome拡張機能です。歪みの補正、写り込みの除去、コントラスト強調などの処理をすべてローカルブラウザ上で行います。",
    features: "特徴",
  ...
  en: {
    ...
    overviewText: "OmniView-Solo is a Chrome extension designed to share physical whiteboard images clearly with remote participants and students in hybrid meetings and remote classes to improve their overall UX. It performs perspective correction, occlusion removal, and contrast enhancement entirely within your local browser.",
    features: "Features",
